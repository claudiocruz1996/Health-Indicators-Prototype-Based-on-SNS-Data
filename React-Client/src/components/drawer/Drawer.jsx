      ...
      >
        ...
        <List>
          ...
          <ListItem button >
                ...
                <ListItemText className={classes.iconsDrawer}>Construction</ListItemText>
          </ListItem>
          <ListItem button >
                <ListItemIcon className={classes.iconsDrawer}><BlockIcon/></ListItemIcon>
                <ListItemText className={classes.iconsDrawer}>Closed</ListItemText>
          </ListItem>
        </List>
        <Divider />
      </Drawer>
